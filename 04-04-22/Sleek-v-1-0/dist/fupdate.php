...
$query = mysqli_query($con,"select * from footwear where Fid='$id'") or die("error in query");
...
Enter Sole Material : 
<input type="text" name="sole" value="<?php echo $sole ?>"/><br/>
Enter Surface type:
<input type="text" name="surface" value="<?php echo $surface ?>"/><br/>
Enter Material:
...
if(isset($_POST['Submit1'])){
    ...
    $con = mysqli_connect("localhost","root","","admin_panel") or die("error in connection");
    $query = mysqli_query($con,"update footwear set Brand_name='$brand',Product_Details='$product',Price=$price,Sole_Material='$sole',Surface_type='$surface',Material='$material',img_url='$img' where Fid='$id'");
    if($query)
    {
