...
while($row=mysqli_fetch_array($query)){
    ...
    echo "</tr>";
    echo "<tr>";
    echo "<td>"."Water Resistance: ".$row["Water_Resistance"]."</td>";
    echo "</tr>";
    echo "<tr>";
    echo "<td>"."Material: ".$row["Material"]."</td>";
    echo "</tr>";
    echo "<tr>";
    echo "<td>"."<a href=bagdelete.php?id=$id>Delete</a>"."</td>";
    echo "</tr>";
    echo "<tr>";
    echo "<td><a href=bagupdate.php?id=$id>Edit</a></td>";
    echo "</tr>";
...
echo "</div>";
echo "<center>";
echo "<a href=bagadd.php>Add More</a><br/><br/>";
