...
$aa="select * from sunglasses where SUNid='$id'";
echo $aa;
$query = mysqli_query($con,$aa) or die("error in query");
...
Enter Id:
<input type-="text" name="id" value="<?php echo $id1 ?>"/><br/>
Enter Brand: 
...
Enter Features:
<input type="text" name="features" value="<?php echo $features ?>"/><br/>
Enter Frame Material:
<input type="text" name="frame" value="<?php echo $frame ?>"/><br/>
Enter Warranty : 
...
if(isset($_POST['Submit1'])){
    ...
    $con = mysqli_connect("localhost","root","","admin_panel") or die("error in connection");
    $query = mysqli_query($con,"update sunglasses set Brand_name='$brand',Product_Details='$product',Price=$price,Features='$features',Frame_material='$frame',Warranty='$warranty',img_url='$img' where SUNid='$id2'");
    if($query)
    {
