...
$query = mysqli_query($con,"select * from shirts where sid=$id") or die("error in query");
...
if(isset($_POST['Submit1'])){
    ...
    $con = mysqli_connect("localhost","root","","admin_panel") or die("error in connection");
    $query = mysqli_query($con,"update shirts set Brand_name='$brand',Product_Details='$product',Price=$price,Size_fit='$size',Material='$material',Fabric='$fabric',Main_trend='$main',img_url='$img' where Sid='$id'");
    if($query)
    {
