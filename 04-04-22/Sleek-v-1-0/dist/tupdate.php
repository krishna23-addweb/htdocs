...
$query = mysqli_query($con,"select * from T_shirts where Tid='$id'") or die("error in query");
...
Enter Main trend: 
<input type="text" name="Main" value="<?php echo $main ?>"/><br/>
Select image :
...
if(isset($_POST['Submit1'])){
    ...
    $con = mysqli_connect("localhost","root","","admin_panel") or die("error in connection");
    $query = mysqli_query($con,"update T_shirts set Brand_name='$brand',Product_Details='$product',Price=$price,Size_fit='$size',Material='$material',Fabric='$fabric',Main_trend='$main',img_url='$img' where Tid='$id'");
    if($query)
    {
