...
while($row=mysqli_fetch_array($query)){
    ...
    echo "</tr>";
    echo "<tr>";
    echo "<td>"."Display: ".$row["Display"]."</td>";
    echo "</tr>";
    echo "<tr>";
    echo "<td>"."Power Source: ".$row["Power_source"]."</td>";
    echo "</tr>";
    echo "<tr>";
    echo "<td>"."<a href=wdelete.php?id=$id>Delete</a>"."</td>";
    echo "</tr>";
    echo "<tr>";
    echo "<td>"."<a href=wupdate.php?id=$id>Edit</a>"."</td>";
    echo "</tr>";
...
echo "</div>";
echo "<center>";
echo "<a href=wadd.php>Add More</a><br/><br/>";
