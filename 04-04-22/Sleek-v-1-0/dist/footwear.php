...
while($row=mysqli_fetch_array($query)){
    ...
    echo "</tr>";
    echo "<tr>";
    echo "<td>"."Sole Material: ".$row["Sole_Material"]."</td>";
    echo "</tr>";
    echo "<tr>";
    echo "<td>"."Surface type: ".$row["Surafce_type"]."</td>";
    echo "</tr>";
    echo "<tr>";
    echo "<td>"."Material: ".$row["Material"]."</td>";
    echo "</tr>";
    echo "<tr>";
    echo "<td>"."<a href=fdelete.php?id=$id>Delete</a>"."</td>";
    echo "</tr>";
    echo "<tr>";
    echo "<td><a href=fupdate.php?id=$id>Edit</a></td>";
    echo "</tr>";
...
echo "</div>";
echo "<center>";
echo "<a href=fadd.php>Add More</a><br/><br/>";
