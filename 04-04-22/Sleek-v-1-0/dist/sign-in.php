              ...
              <form method="post" >
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <input type="submit" class="btn btn-lg btn-primary btn-block mb-4" name="Login" value="Sign In"></input>
...
if(isset($_POST['Login'])){
    ...
    $a = "select * from Sign_up where email='$email' and password='$password'" ;
    //echo $a;
    $query = mysqli_query($con,$a) or die("error in query");
