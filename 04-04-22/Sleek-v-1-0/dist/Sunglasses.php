...
echo "<table class=table card-table table-responsive table-responsive-large style=width:100%>";while($row=mysqli_fetch_array($query)){
    $id=$row["SUNid"];
    echo "<tr>";    
    echo "<td rowspan=10>"."<img src=".$row["img_url"]." height=300px width=200px ></td>";
    echo "</tr>";
    echo "<tr>";
    echo "<td>"."ID: ".$row["SUNid"]."</td>";
    echo "</tr>";
    echo "<tr>";
    ...
    echo "</tr>";
    echo "<tr>";
    echo "<td>"."Features: ".$row["Features"]."</td>";
    echo "</tr>";
    echo "<tr>";
    echo "<td>"."Frame Material: ".$row["Frame_material"]."</td>";
    echo "</tr>";
    echo "<tr>";
    echo "<td>"."Warranty: ".$row["Warranty"]."</td>";
    echo "</tr>";
    echo "<tr>";
    echo "<td>"."<a href=sundelete.php?id=$id>Delete</a>"."</td>";
    echo "</tr>";
    echo "<tr>";
    echo "<td>"."<a href=sunupdate.php?id=$id>Edit</a>"."</td>";
    echo "</tr>";
...
echo "</div>";
echo "<center>";
echo "<a href=sunadd.php>Add More</a><br/><br/>";
echo "</center>";
?>
 </div>
        </div>
