...
while($row=mysqli_fetch_array($query)){
    $id=$row["Tid"];
    echo "<tr>";    
    echo "<td rowspan=11>"."<img src=".$row["img_url"]." height=300px width=200px ></td>";
    echo "</tr>";
    echo "<tr>";
    ...
    echo "</tr>";
    echo "<tr>";
    echo "<td>"."Size & fit: ".$row["Size_fit"]."</td>";
    echo "</tr>";
    echo "<tr>";
    ...
    echo "</tr>";
    echo "<tr>";
    echo "<td>"."Main trend: ".$row["Main_trend"]."</td>";
    echo "</tr>";
    echo "<tr>";
    echo "<td>"."<a href=tdelete.php?id=$id>Delete</a>"."</td>";
    echo "</tr>";
    echo "<tr>";
    echo "<td>"."<a href=tupdate.php?id=$id>Edit</a>"."</td>";
    echo "</tr>";
    echo "<br/>";
    echo "<br/>";
}
...
echo "</div>";
echo "<center>";
echo "<a href=tadd.php>Add More</a><br/><br/>";
echo "</center";
?>
 </div>
        </div>
