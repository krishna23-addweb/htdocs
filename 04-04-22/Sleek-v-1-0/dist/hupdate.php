...
$query = mysqli_query($con,"select * from headphones where Hid='$id'") or die("error in query");
...
Enter Connectivity:
<input type="text" name="connectivity" value="<?php echo $connectivity ?>"/><br/>
Enter Warranty : 
...
if(isset($_POST['Submit1'])){
    ...
    $con = mysqli_connect("localhost","root","","admin_panel") or die("error in connection");
    $query = mysqli_query($con,"update headphones set Brand_name='$brand',Product_Details='$product',Price=$price,Type='$type',Connectivity='$connectivity',Warranty='$warranty',img_url='$img' where Hid='$id'");
    if($query)
    {
