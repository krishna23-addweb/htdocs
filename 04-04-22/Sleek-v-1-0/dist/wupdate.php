...
$query = mysqli_query($con,"select * from watches where Wid='$id'") or die("error in query");
...
Enter Display:
<input type="text" name="Material" value="<?php echo $display ?>"/><br/>
Enter Power Source:
<input type="text" name="Fabric" value="<?php echo $power ?>"/><br/>
Select image :
...
if(isset($_POST['Submit1'])){
    ...
    $con = mysqli_connect("localhost","root","","admin_panel") or die("error in connection");
    $query = mysqli_query($con,"update watches set Brand_name='$brand',Product_Details='$product',Price=$price,Features='$features',Display='$display',Power_source='$Power',img_url='$img' where Wid='$id'");
    if($query)
    {
