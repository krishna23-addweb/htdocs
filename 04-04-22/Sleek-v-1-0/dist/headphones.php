...
while($row=mysqli_fetch_array($query)){
    ...
    echo "</tr>";
    echo "<tr>";
    echo "<td>"."Connectivity: ".$row["Connectivity"]."</td>";
    echo "</tr>";
    echo "<tr>";
    echo "<td>"."Warranty: ".$row["Warranty"]."</td>";
    echo "</tr>";  
    echo "<tr>";
    echo "<td>"."<a href=hdelete.php?id=$id>Delete</a>"."</td>";
    echo "</tr>"; 
    echo "<tr>";
    echo "<td><a href=hupdate.php?id=$id>Edit</a></td>"; 
    echo "</tr>";
}
echo "</table><br/><br/>";
...
echo "</div>";
echo "<center>";
echo "<a href=hadd.php>Add More</a><br/><br/>";
